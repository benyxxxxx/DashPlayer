 ...
 */
public class DashPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *
         * @param player The player for which renderers are being built. {@link DashPlayer#onRenderers}
         *     should be invoked once the renderers have been built. If building fails,
         *     {@link DashPlayer#onRenderersError} should be invoked.
         */
        void buildRenderers(DashPlayer player);
        /**
         * Cancels the current build operation, if there is one. Else does nothing.
         * <p>
         * A canceled build operation must not invoke {@link DashPlayer#onRenderers} or
         * {@link DashPlayer#onRenderersError} on the player, which may have been released.
         */
        void cancel();
    }
    ...
    public DashPlayer(Context context, String userAgent, String contentUri ) {
        this.rendererBuilder = new DashRendererBuilder(context, userAgent, contentUri,
                                                       null/*new WidevineTestMediaDrmCallback(contentId, provider)*/);
     ...
     *
     * @param renderers Renderers indexed by {@link DashPlayer} TYPE_* constants. An individual
